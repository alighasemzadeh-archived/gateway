...
class GatewayServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        //php artisan vendor:publish --provider="Alighasemzadeh\Gateway\GatewayServiceProvider" --tag=config
        $this->publishes([
        ...
        // php artisan vendor:publish --provider="Alighasemzadeh\Gateway\GatewayServiceProvider" --tag=migrations
        $this->publishes([
        ...
        // php artisan vendor:publish --provider="Alighasemzadeh\Gateway\GatewayServiceProvider" --tag=views
        $this->publishes([
